...
const resultSchema=z.object({facts:z.array(z.string().trim().min(1).max(300)).length(9)});
const jsonSchema={type:"object",additionalProperties:false,properties:{facts:{type:"array",minItems:9,maxItems:9,items:{type:"string",minLength:1,maxLength:300}}},required:["facts"]};
