...
export type FoodEntry = { id: string; name: string; amount: string; energy: number; items?: FoodEstimateItem[]; energyRange?: [number,number]; time?: string; sourceText?: string; tasteScore?: number; userTasteScore?: number; createdAt: string };
