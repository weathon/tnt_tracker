...
export type FoodEntry = { id: string; name: string; amount: string; energy: number; time?: string; sourceText?: string; healthScore?: number; tasteScore?: number; healthNotes?: string; createdAt: string };
