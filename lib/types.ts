...
export type FoodEntry = { id: string; name: string; amount: string; energy: number; items?: FoodEstimateItem[]; energyRange?: [number,number]; macros?: FoodMacros; sodiumMg?: number; saltG?: number; time?: string; sourceText?: string; tasteScore?: number; userTasteScore?: number; userTasteNote?: string; createdAt: string };
