...
export type ActivityEntry = { id: string; name: string; duration: string; durationMinutes?: number; met?: number; baseMet?: number; adjustmentPercent?: number; compendiumCode?: string; metRationale?: string; activeEnergy: number; sourceText: string; createdAt: string };
